...
class Menu(ctk.CTkTabview):
	def __init__(self, parent, pos_vars, color_vars, effect_vars, save_func):
		...
		ExportFrame(self.tab('Export'), save_func)
...
class ExportFrame(ctk.CTkFrame):
	def __init__(self, parent, save_func):
		...
		# widgets 
		FileNamePanel(self, self.name_string, self.file_string, self.output_text)
		FilePathPanel(self, self.path_string, self.output_text)
		SaveButton(self, save_func, self.path_string, self.name_string)
